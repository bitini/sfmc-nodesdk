...
module.exports = {
	...
	getToken: async function () {
		...
		let payload = {
			...
			"client_id": "m0ukymbyhevtcjapkxguyob4",
			"client_secret": "ydExf1RIZCQnto5eP4j7d9u4",
			"redirect_uri": "https://mlbapp.herokuapp.com/login/"
		};
				console.log("payload : " , payload);

		return new Promise((resolve, reject) => {
			fetch('https://mct5rqj2m5hmqwlh05v-qstxmh9m.auth.marketingcloudapis.com/v2/token', {
					method: 'POST',
